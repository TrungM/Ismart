        ...
        <div id="content" class="fl-right">                       
            <div class="section" id="detail-page">
                <div class="section-detail">
                  <span style="color:green"><?php echo congratulation("upadate_infor")?></span>  
                    <form action="" method="POST">
                        <?php
                        if(!empty($infor_admin)){

                            foreach($infor_admin as $item){
                        ...
                        <button type="submit" name="btn-update_infor" id="btn-submit">Cập nhật</button>
                    </form>
                </div>
            </div>
        </div>
