<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                    <li class="nav-item">
                    <a href="?mod=product&controller=index&action=category_product" title="" class="nav-link">Danh mục sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=product&controller=index&action=list_product" title="" class="nav-link">Danh sách sản phẩm</a>
                </li>
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=order&controller=index&action=order" title="" class="nav-link">Danh sách đơn hàng</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=order&controller=index&action=customer" title="" class="nav-link">Danh sách khách hàng</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
